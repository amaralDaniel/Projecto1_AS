...
public class AltitudeFilter extends FilterFramework {
    private double altitudeToMeter(double value) {
        return value / 3.2808;
    }
    ...
    public void run() {
        ...
        while (true) {
            ...
            try {
                ...
                double aux = this.altitudeToMeter(databyte);
                //System.out.println("Altitude F: " + databyte + " M: " + aux);
                WriteFilterOutputPort((byte) aux);
